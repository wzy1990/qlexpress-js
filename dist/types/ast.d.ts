 ...
 * 语句联合类型
 */
export type Statement = Program | ExpressionStatement | BlockStatement | IfStatement | WhileStatement | ForStatement | ReturnStatement | BreakStatement | ContinueStatement | VariableDeclaration | FunctionDeclaration | ImportStatement;
/**
 * 宏调用
 */
